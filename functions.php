...
/*****CUSTOM PART BY Kolabor starts here *****/
...
require 'custom/finmarket_custom_post_fields.php';
require 'custom/finmarket_save_posts.php';


/* Show Loans authors */
function custom_post_types_author() {
    add_post_type_support( 'loans', 'author' );
    add_post_type_support( 'deposits', 'author' );
    add_post_type_support( 'auto_liability', 'author' );
    add_post_type_support( 'casco', 'author' );
    add_post_type_support( 'health_travel', 'author' );
    add_post_type_support( 'household', 'author' );
    add_post_type_support( 'life_insurance', 'author' );
}
add_action('init', 'custom_post_types_author');
